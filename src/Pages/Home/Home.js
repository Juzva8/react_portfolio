...
const Home = () => (
  ...
  <Reveal effect="fadeIn" duration={3000}>
     ...
     <h3>I am a former CEO and founder of a transport company with almost one hundred employees. 
       ...
       I moved to the United States in 2017. Since then I got into tech and coding that is why in June of 2020 I decided to sell my company and started UCLA extension for full-stack web developer 
       boot camp which I graduated in February of 2021. I spent a lot of time to learn front and back end web development but that's not it. 
